...
[CreateAssetMenu(menuName = "Research/New Electricity Cost Upgrade")]
public class ResearchElectricityCostUpgradeScriptableObject : ScriptableObject, IResearch
{
    [Header("IResearch")]
    ...
    public void Unlock()
    {
        MachineDatabase.database[this.MachineScriptableObject.Name].ElectricityCost -= this.FieldValue;
    }
}
